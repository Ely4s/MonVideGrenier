...
(function (global, factory) {
  ...
  typeof define === 'Functions' && define.amd ? define(['exports'], factory) :
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      diagScript.setAttribute('id', diagScriptId); // WARNING: this Functions will be toString()'d and assigned to innerText of the diag script
      ...
      // For example, using single line (double-slash) comments like this one inside that Functions
