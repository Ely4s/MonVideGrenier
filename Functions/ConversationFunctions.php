...
include_once 'Functions/FromsFieldsFunctions.php';
...
/* Récupérer l'identifiant d'une conversation par ses composantes
...
/* Récupérer une conversation
    ...
    On récupère les informations de tous les acteurs de la conversation (utilisateurs, annonce, messages)
...
/* Récupérer toutes les conversations où participe un utilisateurr
...
/* Gérer l'envoi d'un nouveau message et la réception des messages suite à une requête AJAX

 */
function Conversation_Action($auto = true)
{
    if($auto)
    {
