...
{
    if(trim($privacy) === PRIVACY_PRIVATE) return 1; else return 0;
}
...
{
    if ($_SESSION[$infoType] === 1) {return"Txt-Opct-0-5";}
    else return "";
}

function getPrivateIconIfPrivateInfo($infoType)
{
    if ($_SESSION[$infoType] === 1) return '<i class="fas fa-eye-slash"></i>';
    else return "";
}
